...
def seed_db():
    ...
    # Items for Order 2 (Final Sale)
    i2_1 = Item(order_id=o2.id, product_name="Clearance T-Shirt", price=30.0, is_final_sale=True, return_window_days=30)
    i2_2 = Item(order_id=o2.id, product_name="Socks", price=50.0, is_final_sale=False, return_window_days=30)

    # Items for Order 3 (Past Window)
    ...
    db.add_all([i1_1, i1_2, i2_1, i2_2, i3_1, i4_1])
    db.commit()
    db.close()
